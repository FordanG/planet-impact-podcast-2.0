<template>
  <div class="container mx-auto pt-16">
    <!-- <div class="pb-12">
      <h1
        class="text-3xl xl:text-5xl font-extrabold text-gray-800 mx-auto text-center xl:text-left pb-4"
      >
        Hear From Our Customers
      </h1>
      <p
        class="text-xl text-gray-600 xl:w-3/4 w-11/12 mx-auto xl:mx-0 text-center sm:text-left"
      >
    ...
    <section id="carousel">
      <figure class="visible">
        <div class="flex flex-wrap justify-around">
          <div
            class="xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:pb-0 pb-12"
          >
          ...
          <div
            class="xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12"
          >
            <div class="shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
              <div class="bg-indigo-700 pt-6 pb-6 pl-6 rounded-tl rounded-tr">
          ...
          >
            <div class="shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
              <div class="bg-indigo-700 pt-6 pb-6 pl-6 rounded-tl rounded-tr">
                <p class="text-xl text-white pb-1">Richard Clark</p>
    ...
    <div
      class="cursor-pointer flex justify-center pt-4 pb-8 sm:pt-8 md:pt-8 lg:pt-8 xl:pt-12"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
